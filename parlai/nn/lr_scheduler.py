...
class ParlAILRScheduler(object):
    ...
    def _init_warmup_scheduler(self, optimizer, states, hard_reset=False):
        ...
        if self.warmup_updates > 0 and (
            ...
            if states.get('warmup_scheduler') and not hard_reset:
    ...
    @classmethod
    def lr_scheduler_factory(cls, opt, optimizer, states):
        """
        ...
        hard_reset = opt.get("optimizer_hard_reset", False)
